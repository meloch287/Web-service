...
def plot_expected_load(hours: np.ndarray, combined_density: np.ndarray, anomaly_windows: list):
...
def plot_actual_load(send_times: np.ndarray, total_sim_seconds: float, bad_transaction_hours: list, good_transaction_hours: list, combined_density: np.ndarray, hours: np.ndarray, anomaly_windows: list):
