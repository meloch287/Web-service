...
```bash
python run_sbp_simulation.py --servers 10 --queue 1000 --rate 100 --lambda 50 --hours 24
```
...
|----------|---------|----------|
| --servers | 10 | Количество серверов (c) |
| --queue | 1000 | Ёмкость очереди (K) |
| --rate | 100.0 | Скорость обслуживания μ (tx/s) |
| --lambda | 50.0 | Базовая интенсивность λ (tx/s) |
| --hours | 24 | Длительность симуляции |
